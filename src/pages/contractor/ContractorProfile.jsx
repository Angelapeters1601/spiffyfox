        ...
        <div className="w-full max-w-md rounded-2xl bg-white p-8 shadow-xl">
          <div className="text-center">
            ...
            <p className="mb-6 text-gray-600">
              It looks like you haven't applied as a contractor yet. Ready to
              join our network?
            </p>
            ...
            <div className="space-y-2">
              <button
                ...
                className="w-full rounded-lg bg-gradient-to-r from-purple-500 to-purple-600 px-4 py-2.5 text-sm font-semibold text-white shadow-sm transition-all hover:from-purple-600 hover:to-purple-700 hover:shadow-md focus:ring-2 focus:ring-purple-500 focus:ring-offset-2 focus:outline-none"
              >
                Browse Contractor Opportunities
              </button>

              <button
                onClick={() => navigate("/contractor-login")}
                className="w-full rounded-lg border border-purple-200 bg-white px-4 py-2.5 text-sm font-medium text-purple-600 transition-all hover:bg-purple-50 focus:ring-2 focus:ring-purple-500 focus:ring-offset-2 focus:outline-none"
              >
                Back to Sign In
              </button>
            </div>
            ...
            <p className="mt-4 text-xs text-gray-400">
              ...
              <button
                ...
                className="font-medium text-purple-500 hover:text-purple-600 hover:underline focus:outline-none"
              >
